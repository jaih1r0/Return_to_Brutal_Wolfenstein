Class BW_BlackGuard_FG42 : BW_MonsterBase 
{
		...
		void FireProjBullets()
		{
			...
			BW_FireMonsterBullet("BW_EnemyMGBullets");
			BW_MiscEffect.SpawnFireFlashFx(self,30,2,38);
			A_Startsound("FG42/Fire", CHAN_AUTO, CHANF_OVERLAP, 0.65);
			A_Startsound("FG42/FireAdd", CHAN_AUTO, CHANF_OVERLAP, 1);
			AmmoInMag--;
		}
		...
		SeeContinue:
			WSS2 AAAABBBB 1 AI_SmartChase();
			TNT1 A 0 A_Fallback();
			WSS2 CCCCBBBB 1 AI_SmartChase();
			TNT1 A 0 A_Fallback();
			Loop;
		FallBack:
		...
		////////////////
		Melee:
			WSS2 A 1 A_CheckLOF(1);
			Goto See;
			WSS2 A 1 A_FaceTarget(45, 45, 0, 0, FAF_MIDDLE);
			WSS2 B random(10,20);
			WS2K B 6
			{
				//Melee attack
		...
		Missile:
			...
			WSS2 E 1 A_CheckLOFRanged("AttackHandler", "Roll");
			Goto See;
		AttackHandler:
			TNT1 A 0
			{
		...
		Attack1:
			...
			WSS2 E 4 A_FaceTarget(45, 45, 0, 0, FAF_MIDDLE);
			WSS2 E random(5,20) A_FaceTarget(45, 45, 0, 0, FAF_MIDDLE);
			WSS2 F 1 BRIGHT FireProjBullets;
			WSS2 E 1;
		...
		Attack2:
			...
			WSS2 E random(5,20) A_FaceTarget(45, 45, 0, 0, FAF_MIDDLE);
			WSS2 F 1 BRIGHT FireProjBullets;
			WSS2 E 2 A_FaceTarget(45, 45, 0, 0, FAF_MIDDLE);
			WSS2 F 1 BRIGHT FireProjBullets;
			WSS2 E 2 A_FaceTarget(45, 45, 0, 0, FAF_MIDDLE);
			WSS2 F 1 BRIGHT FireProjBullets;
		...
		Reload:
			WSS2 H 6;
			WS2R AB 4;
			WS2R C 12 A_StartSound("FG42/MagOutEmpty", 8, CHANF_OVERLAP, attenuation: 2);
			WS2R DC 8;
			WS2R B 8 A_StartSound("FG42/MagInEmpty", 8, CHANF_OVERLAP, attenuation: 2);
			WS2R A 8;
			WSS2 H 6;
			TNT1 A 0
			{
				A_StartSound("FG42/Charge", 8, CHANF_OVERLAP, attenuation: 1.5);
				AmmoInMag = 20;
			}
			WSSR A 8;
			WSS2 H 6;
		...
		SHR:
			...
			WSS2 E 24;
		SHRL:
			WSS2 E 1 A_CheckFloor("SHRE");
			WSS2 E 1;
			Loop;
		SHRE:
			WSS2 E 1 A_FaceTarget;
			TNT1 A 0 A_Stop();
		...
		SHL:
			...
			WSS2 E 24;
		SHLL:
			WSS2 E 1 A_CheckFloor("SHLE");
			WSS2 E 1 A_CheckCeiling("SHLE");
			Loop;
		SHLE:
			WSS2 E 1 A_FaceTarget;
			TNT1 A 0 A_Stop();
