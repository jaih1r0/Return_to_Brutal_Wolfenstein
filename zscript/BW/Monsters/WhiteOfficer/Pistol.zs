Class BW_WhiteOfficer_Pistol : BW_MonsterBase //replaces Zombieman //[Pop] replace is temporary until spawners are implemented. Do we want to do spawner injection?
{
		Default
		{
			Radius 16;
		...
		Reload:
			WTGA E 6;
			WTGR A 6;
			WTGR B 6 A_StartSound("Luger/Out", 8, CHANF_OVERLAP, attenuation: 2);
			WTGR C 6;
			WTGR B 6;
			WTGR A 6 A_StartSound("Luger/In", 8, CHANF_OVERLAP, attenuation: 2);
			WTGR C 2;
			TNT1 A 0
			{
