Class BW_MG42 : BaseBWWeapon
{
	...
	Reload:
		...
		BMGE E 0 A_JumpIf(CountInv("MG42Ammo") < 4, 2);
		BMGU E 0;
		"####" EEE 1 A_Weaponoffset(-0.35,0.2,WOF_ADD);	//moving hand to open it
		"####" EE 1 A_Weaponoffset(0.4,-0.3,WOF_ADD);
		TNT1 A 0 A_Weaponoffset(0,32);
		TNT1 A 0 A_Startsound("Generic/Rattle/Small",CHAN_AUTO);
		MGR0 A 0 A_JumpIf(CountInv("MG42Ammo") < 4, 2);
		MGR4 A 0;
		"####" ABCDEFG 1;
		"####" A 0 A_Startsound("MG42OPEN",CHAN_AUTO);
		"####" HIJKLMNOOOOOOOOOO 1;
		"####" PQRST 1;
		"####" A 0 {If(CountInv("MG42Ammo") > 4) A_Startsound("MG42BeltOut",CHAN_AUTO); }
		"####" A 0 A_Startsound("MG42/MagOut",CHAN_AUTO);
		"####" UVWXYZ 1;
